...
namespace Poker_new
{
    public class CardSetting
    {
        ...
        public void Suffle()
        {
            ...
            temp = trumpCard[firstIdx];
            trumpCard[firstIdx] = trumpCard[secondIdx];
            trumpCard[secondIdx] = temp;
        }
        ...
        //트럼프카드에서 5장을 빼서 나눠준다
        public void CardDraw(List<int>listName, int number)
        {
            for (int index = 0; index < number; index++)
            {
                listName.Add(trumpCard[0]);
